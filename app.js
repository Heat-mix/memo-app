...
const dailyWords = [
  ...
  // 台所用品・保存用品
  "キッチンペーパー", "ラップ", "アルミホイル", "スポンジ", "ジョイ", "キチぺ", "サランラップ", "保存袋", "ジップロック",
  "クッキングシート", "フリーザーバッグ", "キッチンハイター", "キッチンブリーチ",

  // 掃除用品
  "掃除シート", "パイプユニッシュ", "カビキラー", "サンポール", "トイレ洗剤", "お風呂洗剤", "ガラスクリーナー", "消臭剤", "芳香剤",
  "コロコロ", "クイックルワイパー",

  // 紙用品・家庭用消耗品
  "ティッシュ", "トイレットペーパー", "ごみ袋", "ゴミ袋", "日用品",
