...
const stores = [
  // 岩手県・内陸南部：スーパーマーケット・食品店
  "コープ一関コルザ", "コープ花巻あうる", "ベルフ北上", "神文ストア", "カンブン",
  "スーパーオセン", "オセン", "みずかみ", "アクティ", "キクコー", "丸江スーパー", "丸江", "アルテ", "コルザ", "スーパー旭屋",

  // 岩手県・内陸中部：スーパーマーケット・食品店
  "ショッピングプラザたますえ", "カブセンター矢巾店", "カブセンター", "フレッシュたもり", "たもり", "スーパーロッキー", "土日ジャンボ市", "じゃんまる", "たますえ",

  // 岩手県・内陸北部：スーパーマーケット・食品店
  "スーパーとりい", "スーパーみうら", "全日食チェーン", "丸健商店",

  // 岩手県・沿岸北部：スーパーマーケット・食品店
  "マルコシ商店",

  // 岩手県・沿岸中部：スーパーマーケット・食品店
  "シーサイドタウンマスト", "びはんストア", "びはん", "ファル", "マスト", "玉木屋",

  // 岩手県・沿岸南部：スーパーマーケット・食品店
  "アバッセたかた", "サンリア", "三陸屋",

  // 岩手県内の複数地域に共通：スーパーマーケット・食品店
  "産直はなまる市場", "はなまる市場", "ユニバース", "ジョイス", "スーパーアークス", "ビッグハウス", "ベルプラス", "ベルフ",
  "いわて生協", "マルイチ", "マルシェ", "マイヤ", "ビッグプロ",
  ...
  // 岩手県内の複数地域に共通：ドラッグストア・薬店の追加表記
  "ツルハドラッグ", "マツモトキヨシ",

  // ネット通販・オンラインショップ
  "Amazon.co.jp", "Amazon", "楽天市場", "楽天", "Yahoo!ショッピング", "Yahooショッピング", "ヤフーショッピング", "Qoo10",
  "au PAY マーケット", "LOHACO", "アスクル", "ASKUL", "ヨドバシ.com", "ビックカメラ.com",

  // ホームセンター
  "ホームセンターコーナン", "コーナン", "ホームプラザナフコ", "ナフコ", "スーパービバホーム", "ビバホーム",
  "ロイヤルホームセンター", "カインズ", "DCM", "コメリ",

  // スーパーマーケット・食品店
  "スーパーセンタートライアル", "トライアル", "イトーヨーカドー", "イトーヨーカ堂", "マックスバリュ", "ヨークベニマル",
  "業務スーパー", "イオンスーパーセンター", "イオン", "西友", "ライフ", "コストコ", "ロピア", "オーケー", "OK", "Aコープ", "エーコープ", "コープ", "生協",
  "ベイシア", "アピタ", "ピアゴ", "ゆめタウン", "平和堂", "バロー", "オークワ", "マルエツ", "サミット", "ベルク", "スーパー",

  // コンビニ
  "ローソンストア100", "ナチュラルローソン", "ヤマザキデイリーストアー", "デイリーヤマザキ", "ミニストップ",
  "NewDays", "ニューデイズ", "セブン", "ファミマ", "ローソン", "コンビニ",

  // ドラッグストア・薬店
  "ドラッグストアコスモス", "コスモス薬品", "クリエイトSD", "クリエイト", "カワチ薬品", "カワチ", "スギドラッグ", "スギ薬局",
  "ツルハ", "マツキヨ", "ウエルシア", "薬王堂", "サンドラッグ", "ココカラファイン", "クスリのアオキ", "V・ドラッグ",
  "ドラッグセイムス", "セイムス", "ドラッグストア", "薬局",

  // 100円ショップ
  "ダイソー", "セリア", "キャンドゥ", "Can Do", "ワッツ", "Watts", "ミーツ", "シルク", "百均",

  // 家電量販店
  "コジマ×ビックカメラ", "コジマ電気", "コジマ", "ヤマダ電機", "ヤマダ", "ケーズデンキ", "ケーズ", "ヨドバシカメラ", "ヨドバシ",
  "ビックカメラ", "エディオン", "ジョーシン", "Joshin", "ノジマ", "ソフマップ",

  // 衣料品店
  "ワークマンプラス", "ワークマン", "ユニクロ", "GU", "ジーユー", "しまむら", "アベイル", "無印良品", "MUJI", "H&M", "ZARA", "GAP", "ライトオン",

  // フリマサービス
  "Yahoo!オークション", "Yahoo!フリマ", "PayPayフリマ", "メルカリ", "ラクマ", "ジモティー", "ヤフオク",

  // ディスカウントストア・総合店
  "MEGAドン・キホーテ", "メガドンキ", "ドン・キホーテ", "ドンキ", "ダイレックス", "ザ・ビッグ"
];
